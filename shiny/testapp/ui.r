  ...
  tabPanel(strong('選產品'),
    ...
    sidebarLayout(
      ...
      mainPanel(
        ...
        h6('資料來源：UN Comtrade (2012-2016)', align = 'right', style = 'color:#555555'),
        # Copyright notice
  ...
  tabPanel(strong('選市場'),
    ...
    sidebarLayout(
      ...
      sidebarPanel(
        ...
        h5(strong('Step 1: 選擇出口產品')),
        uiOutput('hs2Selector'),
        uiOutput('hs4Selector'),
        uiOutput('hs6Selector'),
        # Choose filtering conditions
        checkboxGroupInput('macro_criteria', label = h5(strong('Step 2: 選擇市場篩選條件')),
      ...
      mainPanel(
        tags$style(type = 'text/css',
                   ...
                   # Competitors table
                   '#competitors_tbl th {color:#555555;}',
                   # Filtered table
                   'table.google-visualization-table-table td:nth-child(6) {text-align: center;}',
                   # Specify gvisTable text and background colors
                   '.myTableHeadRow {color:black; background-color:lightgray;} .myTableRow {color:black;} .myOddTableRow {color:black;}',
                   # App header
                   'span.navbar-brand {font-weight:bold;}'
        ),
        # tags$onMouseover(type = 'text/css',
        #                  '.myTableHeadRow {style.backgroundColor="Khaki"}'),
        width = 9,
        tabsetPanel(
          tabPanel('全球總覽',
            # Title
            ...
            br(),
            h6(em('*註：僅列計對單一國家該項產品年出口額逾 10 萬美元之廠商。'), style = 'color:#555555'),
            hr(),
            # Filtered table
            h3(strong('【市場篩選結果】'), align = 'center', style = 'color:#A50026'),
            h4(strong('共有', htmlOutput('n_filtered', inline = T), '個市場符合篩選條件：'), align = 'center', style = 'color:#555555'),
            htmlOutput('p.table'),
            h6('資料來源：UN Comtrade、貿易局、TAITRA CRM (2012-2016)', align = 'right', style = 'color:#555555'),
            # Copyright notice
            p('Copyright 2017, Taiwan External Trade Development Council', align = 'center')
          ), 
          tabPanel('個別國家',
